...
class ServerFacadeTest {
    ...
    private final Status status9 = new Status(user2, "Testing status 9");

    private final List<Status> statuses = Arrays.asList(status1, status2, status3, status4, status5, status6, status7);
